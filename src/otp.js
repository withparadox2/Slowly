function createEncryptionBuilder() {
  function s(t, s) {
  ...
  function t() {
    var s = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "",
      h = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0,
      n =
    ...
    for (var f = 0; f !== this.seps.length; f++) {
      ...
      ;-1 === c
        ? (this.seps = this.seps.substr(0, f) + " " + this.seps.substr(f + 1))
        : (this.alphabet =
    ...
    ;(this.alphabet = this.alphabet.replace(/ /g, "")),
      ...
      (!this.seps.length || 3.5 < this.alphabet.length / this.seps.length) &&
    ...
    (n = [
      {
        key: "encode",
        value: function() {
          for (var t = arguments.length, s = new Array(t), h = 0; h < t; h++)
            s[h] = arguments[h]
          if (!s.length) return ""
      ...
      },
      {
        ...
        value: function(t, s) {
          for (
            var h = "";
            (h = s.charAt(t % s.length) + h), (t = parseInt(t / s.length, 10));
...
export default function getOtp(time, uid) {
  const Builder = createEncryptionBuilder()
  return new Builder(
